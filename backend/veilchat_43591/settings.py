"""
Django settings for veilchat_43591 project.
...
ROOT_URLCONF = 'veilchat_43591.urls'
...
WSGI_APPLICATION = 'veilchat_43591.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "veilchat_43591 API",
    "DESCRIPTION": "API documentation for veilchat_43591 App",
    "VERSION": "v1",
}
